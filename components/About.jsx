      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-700">
            ...
            became even more excited about creating interactive websites. I&#39;m now
            spending my time developing projects with React Js, Next Js, Redux,
            Firebase, MongoDB, and learning new technologies. Every day, I work
            on extremely complex technical issues and learn from a team of some
            of the most<span className="text-[#5651e5]"> skilled</span> and
